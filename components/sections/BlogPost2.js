...
export default function BlogPost2() {
    return (
        <>
            <section className="blog__post-area-two blog__post-bg-two" data-background="/assets/img/bg/blog_post_bg.jpg">
                <div className="container">
                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-4 col-md-6">
                            <div className="blog__post-two shine-animate-item">
                                <div className="blog__post-thumb-two">
                                    <Link href="/blog-details" className="shine-animate"><img src="/assets/img/blog/h2_blog_post01.jpg" alt="" /></Link>
                                </div>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="blog__post-two shine-animate-item">
                                <div className="blog__post-thumb-two">
                                    <Link href="/blog-details" className="shine-animate"><img src="/assets/img/blog/h2_blog_post02.jpg" alt="" /></Link>
                                </div>
                                <div className="blog__post-content-two">
                                    <div className="blog-post-meta">
                                        <ul className="list-wrap">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="blog__post-two shine-animate-item">
                                <div className="blog__post-thumb-two">
                                    <Link href="/blog-details" className="shine-animate"><img src="/assets/img/blog/h2_blog_post03.jpg" alt="" /></Link>
                                </div>
                                <div className="blog__post-content-two">
                                    <div className="blog-post-meta">
                                        <ul className="list-wrap">
